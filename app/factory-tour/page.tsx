...
export const metadata: Metadata = {
  title: "Factory Tour | Tahui Sweater Factory - See Our Production Facility",
  description: "Take a virtual tour of our modern knitwear manufacturing facility in Shanghai.",
}
...
const facilities = [
  { title: "Production Floor", description: "Our main production hall houses over 200 state-of-the-art seamless knitting machines, organized in efficient production lines with optimized workflow.", image: "/images/linking-workshop.jpg", features: ["200+ WholeGarment machines", "Climate-controlled environment", "Optimized production layout", "Real-time monitoring systems"] },
