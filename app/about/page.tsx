...
export const metadata: Metadata = {
  title: "About Us | Tahui Sweater Factory - 20+ Years of Knitwear Excellence",
  description: "Learn about Tahui Sweater Factory's 20+ year history in knitwear manufacturing.",
}
